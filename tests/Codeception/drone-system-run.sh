...
wget https://joomla.itronic.at/latest/plg_system_ploxdebug.zip -O plg_system_ploxdebug.zip

php cli/joomla.php extension:install --path plg_system_ploxdebug.zip
